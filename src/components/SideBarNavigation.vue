    ...
    <ul class="sidebar-links">
      <li>
        <router-link class="link" :to="{ name: 'home' }">
            <span>
              <img src="../assets/icons/home.svg" alt="home svg"/>
            </span>
          <span>Bosh Sahifa</span>
        </router-link>
      </li>
      <li>
        <p class="link" @click="addNewEmployee">
            <span>
      ...
      <li>
        <p class="link" @click="logoutUser">
            <span>
              <img src="../assets/icons/logout.svg" alt="logout svg"/>
            </span>
          <span>Chiqish</span>
        </p>
      </li>
    </ul>
    <modal :height="600" name="addNewEmployeeModal">
      <TheUserEditorModal
...
export default {
  ...
  methods: {
    ...
    logoutUser() {
      ...
      Cookies.remove('___authorization___token___')
    ...
    addNewEmployee() {
      ...
      this.$modal.show('addNewEmployeeModal')
    },
  }
}
</script>
